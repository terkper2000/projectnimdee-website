        ...
        <div className="container mx-auto px-4 md:px-6 space-y-16">
          ...
          <section>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}
              ...
              <Link href="/resources/biology-20/flashcards?unit=A"
                ...
                <h3 className="text-lg font-serif font-bold text-teal-900 mt-1">Unit A Flashcards</h3>
                <p className="text-sm text-teal-800/70 leading-relaxed flex-1">15 flip cards covering energy flow, ecological pyramids, biogeochemical cycles, and human impacts — pre-filtered to Unit A.</p>
                <span className="text-sm font-bold text-teal-700 group-hover:text-teal-900 flex items-center gap-1 mt-1">
                  Open Unit A Cards <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                </span>
              </Link>
              <Link href="/resources/biology-20/quiz?unit=A"
                ...
                <h3 className="text-lg font-serif font-bold text-amber-900 mt-1">Unit A Practice Quiz</h3>
                <p className="text-sm text-amber-800/70 leading-relaxed flex-1">10 multiple-choice questions on energy flow, trophic levels, biogeochemical cycles, and human impacts — pre-filtered to Unit A.</p>
                <span className="text-sm font-bold text-amber-700 group-hover:text-amber-900 flex items-center gap-1 mt-1">
                  Start Unit A Quiz <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                </span>
              </Link>
            </motion.div>
          </section>
