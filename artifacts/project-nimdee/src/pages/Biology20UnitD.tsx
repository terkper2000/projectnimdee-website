        ...
        <div className="container mx-auto px-4 md:px-6 space-y-16">
          ...
          <section>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}
              ...
              <Link href="/resources/biology-20/flashcards?unit=D"
                ...
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-xs font-bold text-teal-700 bg-teal-100 px-2 py-0.5 rounded-full">18 cards</span>
                </div>
                <h3 className="text-lg font-serif font-bold text-teal-900 mt-1">Unit D Flashcards</h3>
                <p className="text-sm text-teal-800/70 leading-relaxed flex-1">18 flip cards covering blood types, circulation, the immune system, digestion, nephron function, and muscle physiology — pre-filtered to Unit D.</p>
                <span className="text-sm font-bold text-teal-700 group-hover:text-teal-900 flex items-center gap-1 mt-1">
                  Open Unit D Cards <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                </span>
              </Link>
              <Link href="/resources/biology-20/quiz?unit=D"
                ...
                <h3 className="text-lg font-serif font-bold text-amber-900 mt-1">Unit D Practice Quiz</h3>
                <p className="text-sm text-amber-800/70 leading-relaxed flex-1">10 multiple-choice questions on the cardiovascular, immune, digestive, respiratory, and renal systems — pre-filtered to Unit D.</p>
                <span className="text-sm font-bold text-amber-700 group-hover:text-amber-900 flex items-center gap-1 mt-1">
                  Start Unit D Quiz <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                </span>
              </Link>
            </motion.div>
          </section>
